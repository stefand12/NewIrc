...
/*
	Passpromt er okkar lausn til að 
	vera ekki að prompta password input í 
	clear text, kóðann fundum við á stackoverflow
	og aðlöguðum að NewIrc, s.s. með því gera service.
*/
